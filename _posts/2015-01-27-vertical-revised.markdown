...
<div class="feature-sound">
 <div class="feature-wrapper">
  ...
  <ul class="feature-sound-list">
	<li><a id="b00" class="feature-sound-button" href="#">Rustling Leaves</a></li>
	<li><a id="b01" class="feature-sound-button" href="#">Stream Flowing</a></li>
	<li><a id="b02" class="feature-sound-button" href="#">Normal Conversation</a></li>
	<li><a id="b03" class="feature-sound-button" href="#">Laughter</a></li>
	<li><a id="b04" class="feature-sound-button" href="#">Car</a></li>
	<li><a id="b05" class="feature-sound-button" href="#">Truck</a></li>
	<li><a id="b06" class="feature-sound-button" href="#">Jet</a></li>
  </ul>
 </div>
</div>
